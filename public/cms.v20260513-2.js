...
function users() {
  ...
  const usersTable = `
    <section class="cms-panel">
      ...
      <div class="table-wrap">
        <table class="data-table">
          <thead><tr><th>User</th><th>OpenID</th><th>Subscription</th><th>Registered</th><th>Favorites</th><th>Unlocked</th></tr></thead>
          <tbody>
            ${userRows
              .map(
                (user) => `
              ...
              .join("") || `<tr><td colspan="6" class="empty-cell">No users</td></tr>`}
          </tbody>
        </table>
      </div>
    </section>
